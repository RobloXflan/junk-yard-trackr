...
interface PYPVehicleSlotSelectionDialogProps {
  open: boolean;
  onClose: () => void;
...
export function PYPVehicleSlotSelectionDialog({ 
  open, 
  onClose, 
  onSlotSelected, 
  tripNumber,
  vehicleData 
}: PYPVehicleSlotSelectionDialogProps) {
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <div className="text-sm text-muted-foreground">
            PYP Trip {tripNumber} - {format(new Date(), 'MMM d, yyyy')}
          </div>
        </DialogHeader>
