...
import { PublicInventoryAuth } from "@/components/PublicInventoryAuth";
import { Search, LogOut, FileText, CheckCircle, XCircle } from "lucide-react";
...
export const PublicInventory = () => {
  ...
  const handleLogout = () => {
    ...
    toast({
      title: "Logged out",
      description: "You have been logged out of the inventory system",
    });
  };
  ...
  if (!isAuthenticated) {
    return <PublicInventoryAuth onAuthenticated={() => setIsAuthenticated(true)} />;
  }
                ...
                <CardContent className="space-y-3">
                  ...
                  {vehicle.documents && vehicle.documents.length > 0 && (
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span>{vehicle.documents.length} document(s) available</span>
                    </div>
                  )}
                </CardContent>
              </Card>
